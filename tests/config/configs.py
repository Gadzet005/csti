...
class ListConfig(YAMLConfig):
    template = StorageTemplate([
        ...
        ListField("default_enums", EnumField(enumType=Color), default=[Color.red, Color.blue]),
        ListField("matrix", ListField(item=IntField())),
        ListField("default_matrix", ListField(item=IntField()), default=[[1, 2, 3], [4, 5, 6], [7, 8, 9]]),
